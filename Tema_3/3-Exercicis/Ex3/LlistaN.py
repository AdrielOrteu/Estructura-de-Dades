...
################################Definicio Class LlistaN       
    ...
    def MaxElementsLlista(self):
        if self._first is not None:
            return self.MaxElementsLlistaRec(self._first).valor
        else:
            return None
        
    def MaxElementsLlistaRec(self,node: _Node) -> _Node:
        if node.next is None:
            return node
        else:
            other = self.MaxElementsLlistaRec(node.next)
            if node.valor >= other.valor:
                return node
            else:
                return other
